<?
	...
	define("EZSQL_DB_USER", "guitar");			// <-- mysql db user
	define("EZSQL_DB_PASSWORD", "tar2007");		// <-- mysql db password
	define("EZSQL_DB_NAME", "1234bizz");		// <-- mysql db pname
